...
// VirtualizationInterface virtualization interface
// swagger:model VirtualizationInterface
type VirtualizationInterface struct {
	...
	// form factor
	FormFactor *VirtualizationInterfaceFormFactor `json:"form_factor,omitempty"`
	...
	// mode
	Mode *VirtualizationInterfaceMode `json:"mode,omitempty"`
...
// Validate validates this virtualization interface
func (m *VirtualizationInterface) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *VirtualizationInterface) validateCircuitTermination(formats strfmt.Registry) error {
...
func (m *VirtualizationInterface) validateDescription(formats strfmt.Registry) error {
...
func (m *VirtualizationInterface) validateFormFactor(formats strfmt.Registry) error {
...
func (m *VirtualizationInterface) validateInterfaceConnection(formats strfmt.Registry) error {
...
func (m *VirtualizationInterface) validateLag(formats strfmt.Registry) error {
...
func (m *VirtualizationInterface) validateMode(formats strfmt.Registry) error {
...
func (m *VirtualizationInterface) validateMtu(formats strfmt.Registry) error {
...
func (m *VirtualizationInterface) validateName(formats strfmt.Registry) error {
...
func (m *VirtualizationInterface) validateTaggedVlans(formats strfmt.Registry) error {
...
func (m *VirtualizationInterface) validateVirtualMachine(formats strfmt.Registry) error {
...
func (m *VirtualizationInterface) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
