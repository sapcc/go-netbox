...
type WritableCable struct {
	...
	// Type
	// Enum: [1300 1500 1510 1600 1610 1700 3010 3020 3030 3040 3500 5000]
...
func init() {
	var res []int64
	if err := json.Unmarshal([]byte(`[1300,1500,1510,1600,1610,1700,3010,3020,3030,3040,3500,5000]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
