...
func (m *ExtrasTagsListOKBody) validateCount(formats strfmt.Registry) error {
...
func (m *ExtrasTagsListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *ExtrasTagsListOKBody) validatePrevious(formats strfmt.Registry) error {
...
func (m *ExtrasTagsListOKBody) validateResults(formats strfmt.Registry) error {
