...
func (m *ExtrasObjectChangesListOKBody) validateCount(formats strfmt.Registry) error {
...
func (m *ExtrasObjectChangesListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *ExtrasObjectChangesListOKBody) validatePrevious(formats strfmt.Registry) error {
...
func (m *ExtrasObjectChangesListOKBody) validateResults(formats strfmt.Registry) error {
