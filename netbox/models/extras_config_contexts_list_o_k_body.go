...
func (m *ExtrasConfigContextsListOKBody) validateCount(formats strfmt.Registry) error {
...
func (m *ExtrasConfigContextsListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *ExtrasConfigContextsListOKBody) validatePrevious(formats strfmt.Registry) error {
...
func (m *ExtrasConfigContextsListOKBody) validateResults(formats strfmt.Registry) error {
