...
func (o *DcimPowerFeedsListParams) WithAmperage(amperage *float64) *DcimPowerFeedsListParams {
	o.SetAmperage(amperage)
	return o
}

// SetAmperage adds the amperage to the dcim power feeds list params
func (o *DcimPowerFeedsListParams) SetAmperage(amperage *float64) {
	o.Amperage = amperage
}
...
func (o *DcimPowerFeedsListParams) WithPhase(phase *float64) *DcimPowerFeedsListParams {
	o.SetPhase(phase)
	return o
}

// SetPhase adds the phase to the dcim power feeds list params
func (o *DcimPowerFeedsListParams) SetPhase(phase *float64) {
	o.Phase = phase
}
...
func (o *DcimPowerFeedsListParams) WithRegionID(regionID *int64) *DcimPowerFeedsListParams {
	o.SetRegionID(regionID)
	return o
}

// SetRegionID adds the regionId to the dcim power feeds list params
func (o *DcimPowerFeedsListParams) SetRegionID(regionID *int64) {
	o.RegionID = regionID
}
...
func (o *DcimPowerFeedsListParams) WithVoltage(voltage *float64) *DcimPowerFeedsListParams {
	o.SetVoltage(voltage)
	return o
}

// SetVoltage adds the voltage to the dcim power feeds list params
func (o *DcimPowerFeedsListParams) SetVoltage(voltage *float64) {
	o.Voltage = voltage
}
...
func (o *DcimPowerFeedsListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Amperage != nil {
		...
		var qrAmperage float64
		if o.Amperage != nil {
			qrAmperage = *o.Amperage
		}
		qAmperage := swag.FormatFloat64(qrAmperage)
		if qAmperage != "" {
	...
	if o.Phase != nil {
		...
		qPhase := swag.FormatFloat64(qrPhase)
		if qPhase != "" {
	...
	if o.PowerPanelID != nil {
		...
		var qrPowerPanelID int64
		if o.PowerPanelID != nil {
			qrPowerPanelID = *o.PowerPanelID
		}
		qPowerPanelID := swag.FormatInt64(qrPowerPanelID)
		if qPowerPanelID != "" {
	...
	if o.Voltage != nil {
		...
		// query param voltage
		var qrVoltage float64
		if o.Voltage != nil {
			qrVoltage = *o.Voltage
		}
		qVoltage := swag.FormatFloat64(qrVoltage)
		if qVoltage != "" {
