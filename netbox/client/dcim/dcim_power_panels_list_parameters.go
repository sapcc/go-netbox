...
func (o *DcimPowerPanelsListParams) WithRackGroupID(rackGroupID *int64) *DcimPowerPanelsListParams {
	o.SetRackGroupID(rackGroupID)
	return o
}

// SetRackGroupID adds the rackGroupId to the dcim power panels list params
func (o *DcimPowerPanelsListParams) SetRackGroupID(rackGroupID *int64) {
...
func (o *DcimPowerPanelsListParams) WithRegionID(regionID *int64) *DcimPowerPanelsListParams {
	o.SetRegionID(regionID)
	return o
}

// SetRegionID adds the regionId to the dcim power panels list params
func (o *DcimPowerPanelsListParams) SetRegionID(regionID *int64) {
	o.RegionID = regionID
}
